...
    // artists.id is the same UUID as the auth user's id (no separate
    // user_id column exists on this table) — confirmed against schema.
    const artistId = user.id;

    // Confirm the artist profile actually exists before proceeding
...
    // already scheduled — avoids resetting the clock if called twice)
...
    // Soft-delete the artist profile using the existing deleted_at column
